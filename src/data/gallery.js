...
export const facilityImages = [
  { src: facilityFrontAerial, alt: 'Bunyala Industrial Park — front aerial view', caption: 'Industrial Park Front' },
  { src: facilityBackAerial, alt: 'Bunyala Industrial Park — rear aerial view', caption: 'Industrial Park Rear' },
  { src: facilityEntrance1, alt: 'Main facility building entrance', caption: 'Main Entrance' },
  { src: facilityEntrance2, alt: 'Facility building side view', caption: 'Facility Building' },
  { src: facilitySignboard, alt: 'BACIS product signboard at facility', caption: 'BACIS Signboard' },
  { src: lysateProcessing, alt: 'Lysate processing equipment', caption: 'Lysate Processing' },
  { src: sugarBeetField, alt: 'Sugar beet field — agricultural feedstock', caption: 'Sugar Beet Feedstock' },
  { src: additionalAgri1, alt: 'Agriculture operations', caption: 'Agriculture Operations' },
  { src: additionalAgri2, alt: 'Farmland in Western Kenya', caption: 'Climate-Smart Farming' },
  { src: additionalAgri3, alt: 'Crop production', caption: 'Crop Production' },
];

// ─── Event Timeline (News page) ────────────────────────────────────────────────
export const eventImages = [
  { src: event2023Feb16, alt: 'Community meeting, February 2023', caption: 'Feb 2023 — Community Meeting' },
  { src: event2023Mar02, alt: 'Workshop session, March 2023', caption: 'Mar 2023 — Workshop' },
  { src: event2023Mar17a, alt: 'Training session', caption: 'Mar 2023 — Training' },
  { src: event2023May09a, alt: 'Tree planting activity', caption: 'May 2023 — Planting' },
  { src: event2023Oct19a, alt: 'Planting event, October 2023', caption: 'Oct 2023 — Planting' },
  { src: event2024Sep15a, alt: 'Mass tree planting, September 2024', caption: 'Sep 2024 — Mass Planting' },
  { src: event2024Sep15b, alt: 'Community at planting event', caption: 'Sep 2024 — Community Event' },
  { src: event2024Oct04a, alt: 'Event, October 2024', caption: 'Oct 2024 — Event' },
  { src: event2025Mar23a, alt: 'Planting activity, March 2025', caption: 'Mar 2025 — Planting' },
  { src: event2025Apr25a, alt: 'Planting season, April 2025', caption: 'Apr 2025 — Planting Season' },
  { src: event2026Jul05, alt: 'Event, July 2026', caption: 'Jul 2026 — Event' },
  { src: event2026Aug04, alt: 'Community activity, August 2026', caption: 'Aug 2026 — Community Event' },
  { src: event2026Aug13, alt: 'Event, August 2026', caption: 'Aug 2026 — Event' },
];

// ─── Expanded Impact Gallery (Impact page) ─────────────────────────────────────
export const impactGalleryImages = [
  { src: communityEldersImg, alt: 'Community elders engaged in programs', caption: 'Community Elders' },
  { src: treePlantingImg, alt: 'Tree planting ceremony', caption: 'Tree Planting Ceremony' },
  { src: event2023May09b, alt: 'Community tree planting', caption: 'Community Planting' },
  { src: event2024Sep15c, alt: 'Mass tree planting initiative', caption: 'Mass Planting Initiative' },
  { src: event2025Apr25b, alt: 'Farmers during planting season', caption: 'Farmers in Action' },
  { src: outdoorMeetingImg, alt: 'Outdoor community meeting', caption: 'Community Meetings' },
  { src: event2023Oct19b, alt: 'Planting outcome', caption: 'Reforestation Impact' },
  { src: event2026Jul14, alt: 'Community outreach, July 2026', caption: 'Community Outreach' },
];

// ─── About Gallery (About page) ────────────────────────────────────────────────
export const aboutGalleryImages = [
  { src: outdoorMeetingImg, alt: 'Community meeting outdoors', caption: 'Community Engagement' },
  { src: event2023Mar02, alt: 'Strategic workshop', caption: 'Strategic Workshop' },
  { src: event2024Oct04b, alt: 'Partner event', caption: 'Partner Events' },
  { src: event2026Aug13, alt: 'Team activity', caption: 'Team Activities' },
];
